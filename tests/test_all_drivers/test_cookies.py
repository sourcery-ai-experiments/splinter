...
def test_create_and_access_a_cookie(browser):
...
def test_create_many_cookies_at_once_as_dict(browser):
...
def test_create_some_cookies_and_delete_them_all(browser):
...
def test_create_and_delete_a_cookie(browser):
...
def test_create_and_delete_many_cookies(browser):
...
def test_try_to_destroy_an_absent_cookie_and_nothing_happens(browser):
    browser.visit(EXAMPLE_APP)
...
def test_create_and_get_all_cookies(browser):
...
def test_create_and_use_contains(browser):
    """Should be able to create many cookies at once as dict"""
    browser.visit(EXAMPLE_APP)

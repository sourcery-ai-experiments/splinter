...
def test_finding_by_value_in_btn_elements(browser):
    browser.visit(EXAMPLE_APP)
...
def test_finding_last_element_by_css(browser):
    browser.visit(EXAMPLE_APP)
    value = browser.find_by_css("h1").last.value
    assert "Example Last Header" == value


def test_finding_last_element_by_xpath(browser):
    browser.visit(EXAMPLE_APP)
    value = browser.find_by_xpath("//h1").last.value
    assert "Example Last Header" == value


def test_finding_last_element_by_tag(browser):
    browser.visit(EXAMPLE_APP)
    value = browser.find_by_tag("h1").last.value
    assert "Example Last Header" == value


def test_finding_last_element_by_id(browser):
    browser.visit(EXAMPLE_APP)
    value = browser.find_by_id("firstheader").last.value
    assert "Example Header" == value


def test_last_element_is_same_than_first_element_in_find_by_id(browser):
    browser.visit(EXAMPLE_APP)
...
def test_finding_element_by_name_using_slice(browser):
    browser.visit(EXAMPLE_APP)
    value = browser.find_by_name("input1")[-1].value
    assert "default last value" == value


def test_finding_link_by_text_using_slice(browser):
    browser.visit(EXAMPLE_APP)
    link = browser.links.find_by_text("Link for Example.com")[-1]
    assert "http://example.com/last" == link["href"]


def test_finding_link_by_href_using_slice(browser):
...
def test_finding_links_by_text(browser):
...
def test_finding_links_by_href(browser):
...
def test_find_by_css_in_element_context(browser):
...
def test_find_by_xpath_in_element_context(browser):
...
def test_find_by_name_in_element_context(browser):
    browser.visit(EXAMPLE_APP)
    elements = browser.find_by_css("#inside")
...
def test_find_by_tag_in_element_context(browser):
    browser.visit(EXAMPLE_APP)
    elements = browser.find_by_css("#inside")
...
def test_find_by_id_in_element_context(browser):
    browser.visit(EXAMPLE_APP)
    elements = browser.find_by_css("#inside")
...
def test_find_by_value_in_element_context(browser):
    browser.visit(EXAMPLE_APP)
    elements = browser.find_by_css("#inside")
...
def test_finding_by_text_in_element_context(browser):
    browser.visit(EXAMPLE_APP)

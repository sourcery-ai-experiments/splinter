...
def test_access_alerts_and_accept_them(browser):
    browser.visit(EXAMPLE_APP + "alert")
...
def test_access_prompts_and_be_able_to_fill_then(browser):
    browser.visit(EXAMPLE_APP + "alert")
...
def test_access_confirm_and_accept_and_dismiss_them(browser):
    browser.visit(EXAMPLE_APP + "alert")
...
def test_access_confirm_and_accept_and_dismiss_them_using_with(browser):
    browser.visit(EXAMPLE_APP + "alert")
...
def test_access_alerts_using_with(browser):
...
def test_get_alert_return_none_if_no_alerts(browser):

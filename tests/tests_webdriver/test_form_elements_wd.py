...
def test_can_clear_text_field_content(browser):
...
def test_can_clear_password_field_content(browser):
    browser.visit(EXAMPLE_APP)
    my_input = "1nF4m310"
...
def test_can_clear_tel_field_content(browser):
    browser.visit(EXAMPLE_APP)
    my_input = "5553743980"
...
def test_can_clear_textarea_content(browser):
    browser.visit(EXAMPLE_APP)
...
def test_can_clear_search_content(browser):
    browser.visit(EXAMPLE_APP)
...
def test_can_clear_url_content(browser):
    browser.visit(EXAMPLE_APP)

...
def test_is_element_present_by_css(browser):
...
def test_is_element_present_by_css_using_a_custom_wait_time(browser):
...
def test_is_element_present_by_css_returns_false_if_element_is_not_present(browser):
...
def test_is_element_not_present_by_css(browser):
...
def test_is_element_not_present_by_css_returns_false_if_element_is_present(browser):
...
def test_is_element_not_present_by_css_using_a_custom_wait_time(browser):
...
def test_is_element_present_by_xpath(browser):
...
def test_is_element_present_by_xpath_using_a_custom_wait_time(browser):
...
def test_is_element_present_by_xpath_returns_false_if_element_is_not_present(browser):
...
def test_is_element_not_present_by_xpath_returns_false_if_element_is_present(browser):
...
def test_is_element_not_present_by_xpath_using_a_custom_wait_time(browser):
...
def test_is_element_present_by_tag(browser):
...
def test_is_element_present_by_tag_using_a_custom_wait_time(browser):
...
def test_is_element_not_present_by_tag_returns_false_if_element_is_present(browser):
...
def test_is_element_present_by_text(browser):
    "should is element present by text verify if element is present"
    browser.visit(EXAMPLE_APP)
    assert browser.is_element_present_by_text("Complex")


def test_is_element_present_by_text_returns_false_if_element_is_not_present(browser):
    "should is element present by text verify if element is present"
    browser.visit(EXAMPLE_APP)
    assert not browser.is_element_present_by_text("Not present")


def test_is_element_not_present_by_text(browser):
...
def test_is_element_not_present_by_text_returns_false_if_element_is_present(browser):
...
def test_is_element_present_by_value(browser):
...
def test_is_element_present_by_value_using_a_custom_wait_time(browser):
...
def test_is_element_present_by_value_returns_false_if_element_is_not_present(browser):
...
def test_is_element_not_present_by_value(browser):
...
def test_is_element_not_present_by_value_using_a_custom_wait_time(browser):
...
def test_is_element_not_present_by_value_returns_false_if_element_is_present(browser):
...
def test_is_element_present_by_id(browser):
...
def test_is_element_present_by_id_using_a_custom_wait_time(browser):
...
def test_is_element_present_by_id_returns_false_if_element_is_not_present(browser):
...
def test_is_element_not_present_by_id(browser):
...
def test_is_element_not_present_by_id_using_a_custom_wait_time(browser):
...
def test_is_element_not_present_by_id_returns_false_if_element_is_present(browser):
...
def test_is_element_present_by_name(browser):
...
def test_is_element_present_by_name_using_a_custom_wait_time(browser):
...
def test_is_element_present_by_name_returns_false_if_element_is_not_present(browser):
...
def test_is_element_not_present_by_name(browser):
...
def test_is_element_not_present_by_name_using_a_custom_wait_time(browser):
...
def test_is_element_not_present_by_name_returns_false_if_element_is_present(browser):
